...
//ol.proj.get("EPSG:31982").setExtent([387126.883254, 6446122.309188, 404499.133254, 6458272.318962]);
var wms_layers = [];
...
var format_LITERATURA_13 = new ol.format.GeoJSON();
var features_LITERATURA_13 = format_LITERATURA_13.readFeatures(json_LITERATURA_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31982'});
var jsonSource_LITERATURA_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LITERATURA_13.addFeatures(features_LITERATURA_13);
var lyr_LITERATURA_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LITERATURA_13, 
                style: style_LITERATURA_13,
                popuplayertitle: "LITERATURA",
                interactive: true,
                title: '<img src="styles/legend/LITERATURA_13.png" /> LITERATURA'
            });
var format_PATRIMONIO_14 = new ol.format.GeoJSON();
var features_PATRIMONIO_14 = format_PATRIMONIO_14.readFeatures(json_PATRIMONIO_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:31982'});
var jsonSource_PATRIMONIO_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PATRIMONIO_14.addFeatures(features_PATRIMONIO_14);
var lyr_PATRIMONIO_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PATRIMONIO_14, 
                style: style_PATRIMONIO_14,
                popuplayertitle: "PATRIMONIO",
                interactive: true,
                title: '<img src="styles/legend/PATRIMONIO_14.png" /> PATRIMONIO'
            });

lyr_OSMStandard_0.setVisible(true);lyr_ARTESANATO_1.setVisible(true);lyr_ARTESCNICAS_2.setVisible(true);lyr_ARTESVISUAIS_3.setVisible(true);lyr_AUDIOVISUAL_4.setVisible(true);lyr_CARNAVAL_5.setVisible(true);lyr_CULTURAIDENTITRIA_6.setVisible(true);lyr_CULTURATRADICIONALISTA_7.setVisible(true);lyr_DANA_8.setVisible(true);lyr_ECONOMIACRIATIVA_9.setVisible(true);lyr_ESPAOARTEECULTURA_10.setVisible(true);lyr_MSICA_11.setVisible(true);lyr_TEATRO_12.setVisible(true);lyr_LITERATURA_13.setVisible(true);lyr_PATRIMONIO_14.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_ARTESANATO_1,lyr_ARTESCNICAS_2,lyr_ARTESVISUAIS_3,lyr_AUDIOVISUAL_4,lyr_CARNAVAL_5,lyr_CULTURAIDENTITRIA_6,lyr_CULTURATRADICIONALISTA_7,lyr_DANA_8,lyr_ECONOMIACRIATIVA_9,lyr_ESPAOARTEECULTURA_10,lyr_MSICA_11,lyr_TEATRO_12,lyr_LITERATURA_13,lyr_PATRIMONIO_14];
...
lyr_MSICA_11.set('fieldAliases', {'qc_id': 'qc_id', 'latitude': 'latitude', 'longitude': 'longitude', 'nome': 'nome', 'e-mail': 'e-mail', 'descriçã': 'descriçã', 'atuação': 'atuação', 'área de a': 'área de a', 'redes soci': 'redes soci', 'foto ou lo': 'foto ou lo', });
lyr_TEATRO_12.set('fieldAliases', {'id': 'id', 'latitude': 'latitude', 'longitude': 'longitude', 'nome': 'nome', 'e-mail': 'e-mail', 'descriçã': 'descriçã', 'atuação': 'atuação', 'área de a': 'área de a', 'redes soci': 'redes soci', });
lyr_LITERATURA_13.set('fieldAliases', {'id': 'id', 'longitude': 'longitude', 'latitude': 'latitude', 'nome': 'nome', 'email': 'email', 'descriçã': 'descriçã', 'atuação': 'atuação', 'área de a': 'área de a', 'foto, rede': 'foto, rede', });
lyr_PATRIMONIO_14.set('fieldAliases', {'id': 'id', 'latitude': 'latitude', 'longitude': 'longitude', 'nome museu': 'nome museu', 'endereço': 'endereço', 'contato': 'contato', 'email': 'email', 'tipo': 'tipo', 'tipologia': 'tipologia', 'descriçã': 'descriçã', 'acessibili': 'acessibili', 'horários': 'horários', 'observaç�': 'observaç�', });
...
lyr_MSICA_11.set('fieldImages', {'qc_id': 'Range', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'nome': 'TextEdit', 'e-mail': 'TextEdit', 'descriçã': 'TextEdit', 'atuação': 'TextEdit', 'área de a': 'TextEdit', 'redes soci': 'TextEdit', 'foto ou lo': 'TextEdit', });
lyr_TEATRO_12.set('fieldImages', {'id': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'nome': 'TextEdit', 'e-mail': 'TextEdit', 'descriçã': 'TextEdit', 'atuação': 'TextEdit', 'área de a': 'TextEdit', 'redes soci': 'TextEdit', });
lyr_LITERATURA_13.set('fieldImages', {'id': 'TextEdit', 'longitude': 'TextEdit', 'latitude': 'TextEdit', 'nome': 'TextEdit', 'email': 'TextEdit', 'descriçã': 'TextEdit', 'atuação': 'TextEdit', 'área de a': 'TextEdit', 'foto, rede': 'TextEdit', });
lyr_PATRIMONIO_14.set('fieldImages', {'id': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'nome museu': 'TextEdit', 'endereço': 'TextEdit', 'contato': 'TextEdit', 'email': 'TextEdit', 'tipo': 'TextEdit', 'tipologia': 'TextEdit', 'descriçã': 'TextEdit', 'acessibili': 'TextEdit', 'horários': 'TextEdit', 'observaç�': 'TextEdit', });
...
lyr_MSICA_11.set('fieldLabels', {'qc_id': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'nome': 'no label', 'e-mail': 'no label', 'descriçã': 'no label', 'atuação': 'no label', 'área de a': 'no label', 'redes soci': 'no label', 'foto ou lo': 'no label', });
lyr_TEATRO_12.set('fieldLabels', {'id': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'nome': 'no label', 'e-mail': 'no label', 'descriçã': 'no label', 'atuação': 'no label', 'área de a': 'no label', 'redes soci': 'no label', });
lyr_LITERATURA_13.set('fieldLabels', {'id': 'hidden field', 'longitude': 'hidden field', 'latitude': 'hidden field', 'nome': 'no label', 'email': 'no label', 'descriçã': 'no label', 'atuação': 'no label', 'área de a': 'no label', 'foto, rede': 'no label', });
lyr_PATRIMONIO_14.set('fieldLabels', {'id': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'nome museu': 'no label', 'endereço': 'no label', 'contato': 'no label', 'email': 'no label', 'tipo': 'no label', 'tipologia': 'no label', 'descriçã': 'no label', 'acessibili': 'no label', 'horários': 'no label', 'observaç�': 'no label', });
lyr_PATRIMONIO_14.on('precompose', function(evt) {
